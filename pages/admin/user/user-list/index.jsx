...
function createData(firstname, lastname, email, username, action) {
  return {
    key: uniqueId('list'),
    firstname,
    lastname,
...
export default function UserList() {
  ...
  const deleteUser = async () => {
    const deleteData = await axios.delete('/admin/user?id=' + deleteId);
  ...
  useEffect(() => {
    const getData = async () => {
      const userList = await axios.get('/admin/user');
      ...
      <Container className='mt-3'>
        <Box className='admn_pg_ttl'>
          ...
          <Box className='adminttl_action'>
            <a href='/admin/user/create-user' className='btn btn-primary'>
              Create User
            </a>
